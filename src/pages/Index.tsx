    ...
    <div className="min-h-screen bg-gradient-hero relative overflow-hidden">
          ...
          <div className="animate-fade-in-up max-w-5xl mx-auto">
            ...
            <h1 className="text-6xl md:text-7xl font-bold mb-8 leading-tight text-foreground">
              ...
              <span className="text-4xl md:text-5xl font-light text-foreground">
                resultado de 30 dias com a <span className="font-bold text-secondary">beautyness.club</span>
              </span>
            </h1>
      ...
      <div className="container mx-auto px-6 py-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-foreground animate-fade-in-up">
